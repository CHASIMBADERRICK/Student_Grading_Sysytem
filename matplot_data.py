# addition of Matplotlib used to draw and analyse data
...
# --- Title & Info ---
st.title("🎓 Student Grading System — Streamlit (Auto-Save + Charts)")
st.markdown("""
Enter student names and three subject marks.  
The app will automatically validate input, compute averages, assign grades,  
**auto-save all records to CSV**, and display interactive charts 📊.
""")
...
# --- Loops Playground ---
st.subheader("🧠 Loops Playground (Educational Demo)")
...
st.markdown("---")
st.caption("Built with Streamlit — featuring auto-save, charts, and loop demonstrations.")
